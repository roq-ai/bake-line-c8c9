  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Bake Line: Streamlining Your Bakery Business. Our comprehensive management system allows admins to manage products and users to seamlessly purchase their favorite baked goods."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1517433367423-c7e5b0f35086?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxiYWtlcnl8ZW58MHx8fHwxNjk1NTUyMTY2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Bake Line: Streamlining Your Bakery Business. Our comprehensive management system allows admins to manage products and users to seamlessly purchase their favorite baked goods.`}
            </Text>
            <Box
