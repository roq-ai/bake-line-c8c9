...
type ColumnType = ColumnDef<BakeryInterface, unknown>;

interface BakeryListPageProps {
...
export function BakeryListPage(props: BakeryListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<BakeryInterface>>(
    () => `/bakeries?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/bakeries/view/${record.id}`} passHref legacyBehavior>
                <Button
