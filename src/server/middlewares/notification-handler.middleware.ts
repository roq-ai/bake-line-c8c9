...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'payment_made.create': { roles: ['business-owner', 'admin'], key: 'payment_id', tenantPath: [], userPath: [] },
  'item_added.create': { roles: ['business-owner', 'admin'], key: 'item_id', tenantPath: [], userPath: [] },
};
